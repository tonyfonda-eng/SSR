...
def _login_and_get_session():
    # Get credentials from environment, default to the one you provided
    username = os.environ.get("KEDM_USER", "ponap78541@gwshare.com")
    password = os.environ.get("KEDM_PASS", "ponap78541@gwshare.com")
